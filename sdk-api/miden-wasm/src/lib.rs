...
use winter_air::Air;
use winter_crypto::{hashers::Blake2s_256, Digest, ElementHasher};
...
impl MidenProver {
    ...
    fn prove_trace_hashes(&self) -> Result<(), JsValue> {
        ...
        let chunk_size = trace_polys.num_rows() / 8; // 8 threads
