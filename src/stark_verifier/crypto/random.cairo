...
func random_coin_new{range_check_ptr, blake2s_ptr: felt*, bitwise_ptr: BitwiseBuiltin*}(
    seed: felt*, n_bytes: felt
) -> PublicCoin {
...
func get_leading_zeros{range_check_ptr, bitwise_ptr: BitwiseBuiltin*}(seed: felt*) -> felt {
    ...
    with_attr error_message("Error in 2**(log2-1) < seed.high <= 2**log2 verification.") {
